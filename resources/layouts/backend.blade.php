...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('backend/styles/css/themes/lite-purple.min.css') }}">
    <link rel="stylesheet" href="{{ asset('backend/styles/vendor/perfect-scrollbar.css') }}">
</head>
        ...
        <div class="header-part-right">
            ...
            <div class="dropdown">
                <div class="user col align-self-end">
                    <img src="{{ asset('backend/images/faces/1.jpg') }}" id="userDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <table id="user_table" class="table  text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img class="rounded-circle m-0 avatar-sm-table " src="{{ asset('backend/images/faces/1.jpg') }}" alt="">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3">
                            <img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="{{ asset('backend/images/products/headphone-4.jpg') }}" alt="">
                        ...
                        <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3">
                            <img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="{{ asset('backend/images/products/headphone-2.jpg') }}" alt="">
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3">
                            <img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="{{ asset('backend/images/products/headphone-3.jpg') }}" alt="">
                            <div class="flex-grow-1">
    ...
    <div class="search-results list-horizontal">
        <div class="list-item col-md-12 p-0">
            <div class="card o-hidden flex-row mb-4 d-flex">
                <div class="list-thumb d-flex">
                    <!-- TUMBNAIL -->
                    <img src="{{ asset('backend/images/products/headphone-1.jpg') }}" alt="">
                </div>
        ...
        <div class="list-item col-md-12 p-0">
            <div class="card o-hidden flex-row mb-4 d-flex">
                <div class="list-thumb d-flex">
                    <!-- TUMBNAIL -->
                    <img src="{{ asset('backend/images/products/headphone-2.jpg') }}" alt="">
                </div>
                <div class="flex-grow-1 pl-2 d-flex">
                    <div class="card-body align-self-center d-flex flex-column justify-content-between align-items-lg-center flex-lg-row">
                        <!-- OTHER DATA -->
        ...
        <div class="list-item col-md-12 p-0">
            <div class="card o-hidden flex-row mb-4 d-flex">
                <div class="list-thumb d-flex">
                    <!-- TUMBNAIL -->
                    <img src="{{ asset('backend/images/products/headphone-3.jpg') }}" alt="">
                </div>
                <div class="flex-grow-1 pl-2 d-flex">
                    <div class="card-body align-self-center d-flex flex-column justify-content-between align-items-lg-center flex-lg-row">
                        <!-- OTHER DATA -->
        ...
        <div class="list-item col-md-12 p-0">
            <div class="card o-hidden flex-row mb-4 d-flex">
                <div class="list-thumb d-flex">
                    <!-- TUMBNAIL -->
                    <img src="{{ asset('backend/images/products/headphone-4.jpg') }}" alt="">
                </div>
                <div class="flex-grow-1 pl-2 d-flex">
                    <div class="card-body align-self-center d-flex flex-column justify-content-between align-items-lg-center flex-lg-row">
                        <!-- OTHER DATA -->
...
<script src="{{ asset('backend/js/vendor/echarts.min.js') }}"></script>

<script src="{{ asset('backend/js/es5/echart.options.min.js') }}"></script>
<script src="{{ asset('backend/js/es5/dashboard.v1.script.min.js') }}"></script>
<script src="{{ asset('backend/js/es5/script.min.js') }}"></script>
</body>
