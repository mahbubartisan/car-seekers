            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="about_thumb">
                        <img src="{{ asset('templates/frontend/img/about/about1.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="about_content">
                        <h1>Welcome To <span class="text-danger">Car</span>Seekers!</h1>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single_counterup">
                        <div class="counter_img">
                            <img src="{{ asset('templates/frontend/img/about/count.png') }}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single_counterup count-two">
                        <div class="counter_img">
                            <img src="{{ asset('templates/frontend/img/about/count2.png') }}" alt="">
                        </div>
                        <div class="counter_info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single_counterup">
                        <div class="counter_img">
                            <img src="{{ asset('templates/frontend/img/about/count3.png') }}" alt="">
                        </div>
                        <div class="counter_info">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single_counterup count-two">
                        <div class="counter_img">
                            <img src="{{ asset('templates/frontend/img/about/count4.png') }}" alt="">
                        </div>
                        <div class="counter_info">
                            <h2 class="counter_number">2170</h2>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="about__img">
                        <img src="{{ asset('templates/frontend/img/about/about2.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="brand_container owl-carousel">
                        <div class="single_brand">
                            <a href="#"><img src="{{ asset('templates/frontend/img/brand/brand.png') }}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{ asset('templates/frontend/img/brand/brand1.png') }}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{ asset('templates/frontend/img/brand/brand2.png') }}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{ asset('templates/frontend/img/brand/brand3.png') }}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{ asset('templates/frontend/img/brand/brand4.png') }}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{ asset('templates/frontend/img/brand/brand5.png') }}" alt=""></a>
                        </div>
                        <div class="single_brand">
                            <a href="#"><img src="{{ asset('templates/frontend/img/brand/brand1.png') }}" alt=""></a>
                        </div>
