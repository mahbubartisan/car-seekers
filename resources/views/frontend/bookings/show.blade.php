    ...
    <div class="col-md-12 form-group">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text" style="width: 120px"><i class="fa fa-calendar mr-2"></i> End Date</span>
                    </div>
            ...
            <div class="col-md-6">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text" style="width: 120px"><i class="fa fa-clock-o mr-2"></i> End Time</span>
                    </div>
